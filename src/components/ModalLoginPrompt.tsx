      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-8 relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6 text-sm">
            Para ver detalhes dos produtos e entrar em contato com os vendedores, você precisa estar logado no Mercadinho Universitário.
          </p>

          <div className="space-y-3">
            <Link
              href="/login"
              className="block w-full bg-[#FF385C] text-white font-semibold py-3 rounded-lg hover:bg-[#e0314f] transition"
            >
              Entrar agora
            </Link>
            <Link
